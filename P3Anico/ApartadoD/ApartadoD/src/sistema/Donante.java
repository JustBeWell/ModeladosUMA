...
public class Donante {
    ...
    public Donante(float cantidad, Socio socio) { //Se ha decidido meter la cantidad en el constructor, ya que es una condición necesaria y suficiente para ser donante.
    ...
    public void donar(float cantidad){ //En vez de utilizar
        ...
        addDonacion(d);
        Refugio r = this.getSocio().getRefugio(); //Como hereda de la clase socio podemos acceder al refugio de la clase padre
