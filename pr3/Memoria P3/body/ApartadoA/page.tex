...
\usepackage{float}
\usepackage{hyperref}
\usepackage{lipsum} % Para texto de relleno, puedes eliminarlo si no lo necesitas
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ruta/a/la/imagen1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ruta/a/la/imagen2.png}
