...
\begin{itemize}
\item \textbf{esSometido (Coche-Revisión)}:  Esta relación indica que cada coche en el sistema puede estar asociado a múltiples revisiones a lo largo de su vida útil. Cada revisión se registra cuando el coche necesita mantenimiento o reparación.Cada revision es realizada a un unico coche a la vez a lo sumo mientras que un coche puede ser revisado muchas veces en distintos instantes de tiempo.
