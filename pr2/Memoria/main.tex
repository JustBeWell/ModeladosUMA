...
\begin{itemize}
  ...
  context Ciudad
    ...
    \item \textbf{10.}: Un coche debe de estar en la ciudad origen de un recorrido antes de iniciar un viaje
    \begin{lstlisting}[style = useEspecifico,language=SQL]
  context Coche
...
\newpage
\section{Modelado Dinámico - NO SEGUIR HASTA ASEGURADO}
...
\subsection{Nuevas adiciones al sistema para el modelo dinámico}
\subsubsection{Atributo 'Velocidad' en la clase Coche}
\textbf{Descripción}:  Este atributo ha sido incluido para capturar la capacidad de desplazamiento de cada coche y permitir el cálculo de tiempos de viaje en función de la velocidad específica de cada instancia.

\subsubsection{Atributo 'kmViaje' en la clase Viaje}
\textbf{Descripción}:  
Se ha añadido para representar la distancia de cada viaje en kilómetros.
